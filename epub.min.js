!function (t, e) {
  ...
  return function (t) {
    ...
    function v(t) {
      var e = window.getComputedStyle(t), i = 0, n = 0;
      return [
        "width",
        "paddingRight",
        "paddingLeft",
    ...
    function B(t, e, i) {
      ...
      if (
        ...
        (n = t.querySelector(`${e}[*|type="${i}"]`)), n && 0 !== n.length
      ) return n;
      n = A(t, e);
    ...
    class H {
      ...
      selectNode(t) {
        let e = t.parentNode, i = Array.prototype.indexOf.call(e.childNodes, t);
      ...
      _commonAncestorContainer(t, e) {
        var i = F(t || this.startContainer), n = F(e || this.endContainer);
        if (i[0] == n[0]) {
    ...
    class s {
      ...
      checkType(t) {
        return this.isCfiString(t) ? "string" : !t || "object" != typeof t ||
      ...
      parse(t) {
        ...
        return "string" != typeof t
          ? { spinePos: -1 }
          : (0 === t.indexOf("epubcfi(") && ")" === t[t.length - 1] &&
      ...
      parseComponent(t) {
        var e,
          ...
          n = t.split(":"),
          s = n[0].split("/");
        return n.length > 1 && (e = n[1], i.terminal = this.parseTerminal(e)),
          "" === s[0] && s.shift(),
      ...
      segmentString(t) {
        ...
        return e += this.joinSteps(t.steps),
          t.terminal && null != t.terminal.offset &&
          (e += ":" + t.terminal.offset),
          t.terminal && null != t.terminal.assertion &&
      ...
      pathTo(t, e, i) {
        for (
          ...
          s.steps.unshift(n), r = r.parentNode;
        }
        return null != e && e >= 0 &&
          (s.terminal.offset = e,
      ...
      equalStep(t, e) {
        return !(!t || !e) &&
          (t.index === e.index && t.id === e.id && t.type === e.type);
      }
      fromRange(t, e, i) {
      ...
      findNode(t, e, i) {
        ...
        return i || void 0 === r.evaluate
          ? n = i ? this.walkToNode(t, r, i) : this.walkToNode(t, r)
          : (s = this.stepsToXpath(t),
            n =
              r.evaluate(s, r, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)
                .singleNodeValue),
          n;
      }
      fixMiss(t, e, i, n) {
      ...
      isCfiString(t) {
        return "string" == typeof t && 0 === t.indexOf("epubcfi(") &&
          ")" === t[t.length - 1];
      }
      ...
      a = {
        on: n = function (t, e) {
          ...
          return u(e),
            ...
            i[t]
              ? "object" == typeof i[t] ? i[t].push(e) : i[t] = [i[t], e]
              : i[t] = e,
            this;
        },
        once: s,
    ...
    "use strict";
    var n = i(4), s = i(7), r = i.n(s);
    e.a = class {
      constructor(t, e) {
        var i = t.indexOf("://") > -1, s = t;
        if (
          this.Url = void 0,
            this.href = t,
            this.protocol = "",
            ...
            this.search = "",
            this.base = e,
            !i && !1 !== e && "string" != typeof e && window &&
            window.location && (this.base = window.location.href),
            i || this.base
        ) {
          try {
            this.base
    ...
    e.a = class {
      ...
      register() {
        for (var t = 0; t < arguments.length; ++t) {
          ...
          else {for (var e = 0; e < arguments[t].length; ++e) {
      ...
      trigger() {
        var t = arguments, e = this.context, i = [];
      ...
      for (var i, n = "", s = -1, r = 0, o = 0; o <= t.length; ++o) {
        ...
        if (47 === i) {
          if (s === o - 1 || 1 === r);
            ...
            if (
              n.length < 2 || 46 !== n.charCodeAt(n.length - 1) ||
    ...
    var o = {
      ...
      normalize: function (t) {
        ...
        var e = 47 === t.charCodeAt(0), i = 47 === t.charCodeAt(t.length - 1);
      ...
      format: function (t) {
        ...
        return function (t, e) {
          var i = e.dir || e.root, n = e.base || (e.name || "") + (e.ext || "");
    ...
    var a = i(11), h = i(9), l = i(28), c = i.n(l);
    var u = class {
      constructor(t) {
        this.settings = t || {},
      ...
      getElement(t) {
        ...
        if (
          Object(r.isElement)(t)
            ? e = t
            : "string" == typeof t && (e = document.getElementById(t)), !e
      ...
      size(t, e) {
        var i;
        let n = t || this.settings.width, s = e || this.settings.height;
        null === t
        ...
        return n || (t = o.width - h - l),
          (this.settings.fullsize && !s || !s) && (e = o.height - c - u),
          {
            ...
            height: e - this.containerPadding.top -
              this.containerPadding.bottom,
          };
      }
      bounds() {
        let t;
        return "visible" !== this.container.style.overflow &&
      ...
      axis(t) {
        "horizontal" === t
          ...
          : this.container.style.display = "block", this.settings.axis = t;
      }
      direction(t) {
        this.container &&
      ...
      overflow(t) {
        ...
        ("scroll" === t && "vertical" === this.settings.axis
          ...
          : this.container.style.overflow = t), this.settings.overflow = t;
      }
      destroy() {
        this.element &&
    ...
    class p {
      ...
      render(t, e) {
        let i = t.tagName;
        void 0 !== this.settings.fullsize || !i ||
      ...
      resize(t, e, i) {
        ...
        this.winBounds = Object(r.windowBounds)(),
          this.orientationTimeout &&
            ...
            : this._stageSize && this._stageSize.width === n.width &&
      ...
      display(t, e) {
        ...
        if (s && t && "pre-paginated" !== this.layout.name) {
          ...
          if (e) {
            let t = s.locationOf(e), i = s.width();
            this.moveTo(t, i);
          }
          return i.resolve(), n;
        }
        this.clear();
        let o = !1;
        return "pre-paginated" === this.layout.name &&
          2 === this.layout.divisor &&
          t.properties.includes("page-spread-right") && (o = !0),
          this.add(t, o).then(
            function (t) {
              if (e) {
                let i = t.locationOf(e), n = t.width();
                this.moveTo(i, n);
              }
            }.bind(this),
            (t) => {
        ...
        this.isPaginated
          ? ((i = Math.floor(t.left / this.layout.delta) * this.layout.delta) +
            ...
            (n = Math.floor(t.top / this.layout.delta) * this.layout.delta) +
                  this.layout.delta > this.container.scrollHeight &&
      ...
      next() {
        ...
        if (this.views.length) {
          ...
          } else {this.scrollLeft = this.container.scrollLeft,
          ...
          if (t) {
            ...
            return "pre-paginated" === this.layout.name &&
              2 === this.layout.divisor &&
              t.properties.includes("page-spread-right") && (e = !0),
              this.append(t, e).then(
                function () {
      ...
      prev() {
        ...
        if (this.views.length) {
          ...
          if (t) {
            ...
            let e = !1;
            return "pre-paginated" === this.layout.name &&
              2 === this.layout.divisor && "object" != typeof t.prev() &&
              (e = !0),
              this.prepend(t, e).then(
                function () {
                  var e;
                  if (
                    "pre-paginated" === this.layout.name &&
                    this.layout.divisor > 1 && (e = t.prev())
          ...
          t.map((t) => {
            ...
            s
              ...
              : (o = r + e.left - d.left + 0,
                ...
                h = n);
            let g = Math.ceil(o / h), m = [], v = Math.ceil(a / h);
      ...
      isVisible(t, e, i, n) {
        var s = t.position(), r = n || this.bounds();
        return "horizontal" === this.settings.axis && s.right > r.left - e &&
            s.left < r.right + i ||
          "vertical" === this.settings.axis && s.bottom > r.top - e &&
            s.top < r.bottom + i;
      }
      visible() {
        for (
      ...
      updateFlow(t, e = "auto") {
        ...
        this.isPaginated = i,
          "scrolled-doc" === t || "scrolled-continuous" === t ||
            "scrolled" === t
            ...
            n = o.shift(),
              r = this.walk(n, (t) => {
                ...
                if (
                  ...
                  if (
                    n = Math.round(c.left), r = Math.round(c.right), n > i && a
                  ) return a;
                  if (r > i) return t;
                  a = t, o.push(t);
                } else if (this.horizontal && "rtl" === this.direction) {
                  ...
                  if (
                    h = Math.round(c.top), l = Math.round(c.bottom), h > i && a
                  ) return a;
                  if (l > i) return t;
                  a = t, o.push(t);
                }
    ...
    "use strict";
    var n = i(3), s = i.n(n), r = i(0), o = i(2), a = i(11), h = i(8), l = i(1);
    ...
    class f {
      ...
      imageLoadListeners() {
        for (
          ...
          void 0 !== (t = e[i]).naturalWidth && 0 === t.naturalWidth &&
            (t.onload = this.expand.bind(this));
        }
      }
      fontLoadListeners() {
        this.document && this.document.fonts &&
        ...
        if (this.epubcfi.isCfiString(t)) {
          ...
          if (s) {
            ...
            if (s.startContainer.nodeType === Node.ELEMENT_NODE) {
              ...
              let t = s.startContainer, e = new Range();
              try {
                1 === t.nodeType
            ...
            ? (n = this.document.querySelector("link[href='" + t + "']"))
              ...
              : ((n = this.document.createElement("link")).type = "text/css",
                ...
                n.onload = n.onreadystatechange = function () {
                  s || this.readyState && "complete" != this.readyState ||
                    (s = !0,
                      setTimeout(() => {
                        e(!0);
                      }, 1));
      ...
      addClass(t) {
        var e;
        this.document && (e = this.content || this.document.body) &&
          e.classList.add(t);
      }
      removeClass(t) {
        var e;
      ...
      columns(t, e, i, n, s) {
        let o = Object(r.prefixed)("column-axis"),
          ...
          c = 0 === this.writingMode().indexOf("vertical")
            ? "vertical"
            : "horizontal";
            ...
            value: function () {
              ...
              return t.filter(function (e) {
                for (var i = 0; i < t.length; i++) {
                  ...
                  if (
                    n = t[i],
                      (s = e).right <= n.right && s.left >= n.left &&
          ...
          n(e, [{
            ...
            value: function () {
              ...
              for (
                ...
                var a = e[r], h = s.default.createElement("rect");
    ...
    "use strict";
    var n = i(3), s = i.n(n), r = i(0), o = i(6), a = i(2), h = i(9), l = i(1);
    class c {
      constructor(t) {
        this.settings = t,
          ...
          "scrolled" === t.flow || "scrolled-continuous" === t.flow ||
            "scrolled-doc" === t.flow
            ? this._flow = "scrolled"
      ...
      flow(t) {
        return void 0 !== t &&
          (this._flow = "scrolled" === t || "scrolled-continuous" === t ||
              "scrolled-doc" === t
            ? "scrolled"
            : "paginated",
      ...
      spread(t, e) {
        return t &&
          (this._spread = "none" !== t, this.update({ spread: this._spread })),
      ...
      calculate(t, e, i) {
        ...
        a = this._spread && l >= this._minSpreadWidth ? 2 : 1,
          "reflowable" !== this.name || "paginated" !== this._flow || i >= 0 ||
          (h = u % 2 == 0 ? u : u - 1),
    ...
    var f = class {
      ...
      inject(t) {
        ...
        for (var s in n) {
          !n.hasOwnProperty(s) || s !== this._current && "default" !== s ||
            (((e = n[s]).rules && Object.keys(e.rules).length > 0 ||
              e.url && -1 === i.indexOf(e.url)) && this.add(s, t),
    ...
    class b {
      ...
      _display(t) {
        if (this.book) {
          ...
          return this.displaying = i,
            this.book.locations.length() && Object(r.isFloat)(t) &&
      ...
      afterDisplayed(t) {
        t.on(
          l.c.VIEWS.MARK_CLICKED,
          (e, i) => this.triggerMarkEvent(e, i, t.contents),
        ),
      ...
      onResized(t, e) {
        this.emit(
          ...
          this.location && this.location.start &&
      ...
      next() {
        return this.q.enqueue(this.manager.next.bind(this.manager)).then(
          this.reportLocation.bind(this),
        );
      }
      prev() {
        return this.q.enqueue(this.manager.prev.bind(this.manager)).then(
          this.reportLocation.bind(this),
        );
      }
      determineLayoutProperties(t) {
        ...
        return (0 === this.settings.width || this.settings.width > 0) &&
      ...
      flow(t) {
        var e = t;
        "scrolled" !== t && "scrolled-doc" !== t &&
          "scrolled-continuous" !== t || (e = "scrolled"),
          "auto" !== t && "paginated" !== t || (e = "paginated"),
          this.settings.flow = t,
          this._layout && this._layout.flow(e),
          this.manager && this._layout &&
          this.manager.applyLayout(this._layout),
          this.manager && this.manager.updateFlow(e),
          this.manager && this.manager.isRendered() && this.location &&
      ...
      spread(t, e) {
        this.settings.spread = t,
          ...
          this.manager && this.manager.isRendered() &&
      ...
      located(t) {
        ...
        return -1 != o && (n.start.page = o),
          ...
          n.end.displayed.page >= n.end.displayed.total && (n.atEnd = !0),
          e.index === this.book.spine.first().index &&
          1 === n.start.displayed.page && (n.atStart = !0),
          n;
      }
      destroy() {
    ...
    class c {
        ...
        return this.create(),
          ...
          this.sectionRender.then(function (t) {
            ...
            function () {
              ...
              return t = "scrolled" === this.settings.flow
                ? 0 === e.indexOf("vertical") ? "horizontal" : "vertical"
      ...
      reset() {
        ...
        (this.iframe.style.width = "0",
          ...
          this._contentHeight = void 0), this._needsReframe = !0;
      }
      size(t, e) {
        var i = t || this.settings.width, n = e || this.settings.height;
        "pre-paginated" === this.layout.name
          ? this.lock("both", i, n)
      ...
      lock(t, e, i) {
        ...
        n = this.iframe
          ...
          : { width: 0, height: 0 },
          "width" == t && Object(r.isNumber)(e) &&
          (this.lockedWidth = e - s.width - n.width),
          "height" == t && Object(r.isNumber)(i) &&
          (this.lockedHeight = i - s.height - n.height),
          "both" === t && Object(r.isNumber)(e) && Object(r.isNumber)(i) &&
          (this.lockedWidth = e - s.width - n.width,
            this.lockedHeight = i - s.height - n.height),
      ...
      highlight(t, e = {}, i, n = "epubjs-hl", s = {}) {
        ...
        let c = new l.Highlight(o, n, e, r), u = this.pane.addMark(c);
      ...
      underline(t, e = {}, i, n = "epubjs-ul", s = {}) {
        ...
        e.epubcfi = t,
          this.pane || (this.pane = new l.Pane(this.iframe, this.element));
        let c = new l.Underline(o, n, e, r), u = this.pane.addMark(c);
      ...
      mark(t, e = {}, i) {
        ...
        return a.setAttribute("ref", "epubjs-mk"),
          ...
          i &&
          (a.addEventListener("click", i), a.addEventListener("touchstart", i)),
        ...
        if (
          ...
          for (var r = 0; r != o.length; r++) {
            t = o[r],
              (!s || t.left < s) &&
              (s = t.left,
                n = Math.ceil(s / this.layout.props.pageWidth) *
    ...
    var n = i(19), s = i(51), r = i(53), o = Math.max, a = Math.min;
    ...
    "use strict";
    var n = i(0), s = i(10), r = i(1), o = i(3), a = i.n(o);
    const h = Math.PI / 2,
      l = {
    ...
    class c {
      ...
      setup(t) {
        this.manager = t,
          ...
          this.manager.settings.afterScrolledTimeout = 2 *
      ...
      needsSnap() {
        return this.scrollLeft %
            (this.layout.pageWidth * this.layout.divisor) != 0;
      }
      snap(t = 0) {
      ...
      smoothScrollTo(t) {
        ...
        return this.snapping = !0,
          function n() {
            const a = this.now(), h = Math.min(1, (a - s) / r);
    ...
    class p extends s.a {
      constructor(t) {
        super(t),
          ...
          "undefined" != t.settings.gap && 0 === t.settings.gap &&
      ...
      update(t) {
        for (
          ...
          if (e = s[c], !0 === this.isVisible(e, a, a, i)) {
            ...
            o.push(e);
          } else {this.q.enqueue(e.destroy.bind(e)),
      ...
      check(t, e) {
        ...
        let h = r ? this.scrollLeft : this.scrollTop,
          ...
          u = this.writingMode && 0 === this.writingMode.indexOf("vertical")
            ? "vertical"
            : "horizontal",
        ...
        let p = () => {
            let t = this.views.first(), e = t && t.section.prev();
            e && s.push(this.prepend(e));
          },
          g = h - o;
        h + l + o >= c && (() => {
          let t = this.views.last(), e = t && t.section.next();
          e && s.push(this.append(e));
        })(), g < 0 && p();
        let m = s.map((t) => t.display(this.request));
        return s.length
          ? Promise.all(m).then(() => this.check()).then(
            () => this.update(o),
            (t) => t,
          )
      ...
      addEventListeners(t) {
        window.addEventListener(
          ...
          this.isPaginated && this.settings.snap &&
          (this.snapper = new u(
            this,
            this.settings.snap && "object" == typeof this.settings.snap &&
              this.settings.snap,
          ));
      }
      addScrollListeners() {
        var t;
        this.tick = n.requestAnimationFrame;
        let e = "rtl" === this.settings.direction &&
            "default" === this.settings.rtlScrollType
          ? -1
          : 1;
      ...
      scrolled() {
        this.q.enqueue(function () {
          ...
          this.afterScrolled = setTimeout(
            function () {
              this.snapper && this.snapper.supportsTouch &&
      ...
      updateFlow(t) {
        this.rendered && this.snapper &&
        (this.snapper.destroy(), this.snapper = void 0),
          super.updateFlow(t, "scroll"),
          this.rendered && this.isPaginated && this.settings.snap &&
          (this.snapper = new u(
            this,
            this.settings.snap && "object" == typeof this.settings.snap &&
              this.settings.snap,
      ...
      }(
        {
          1: [function (t, i, n) {
            (function (t) {
              ...
              if (s) {
                var r = 0, o = new s(c), a = t.document.createTextNode("");
          ...
          2: [function (t, e, i) {
            ...
            var n = t(1);
            function s() {}
            var r = {}, o = ["REJECTED"], a = ["FULFILLED"], h = ["PENDING"];
            function l(t) {
          ...
          4: [function (t, e, i) {
            ...
            var u = void 0, d = {}, f = Object.prototype.toString;
            function p(t) {
              return "boolean" == typeof u ? o.resolve(u) : function (t) {
                return new o(function (e) {
                  var i = t.transaction(
                    ...
                    n = r([""]);
                  i.objectStore("local-forage-detect-blob-support").put(
                    n,
                    "key",
                  ),
                  ...
                  try {
                    ...
                    console.warn(
                      'The database "' + t.name +
                        ...
                        " to version " + e.newVersion + ', but the storage "' +
                        t.storeName + '" already exists.',
                    );
                  }
                }),
            ...
            function x(t, e) {
              ...
              if (
                ...
                (t.version !== e &&
                  console.warn(
                    'The database "' + t.name +
                      "\" can't be downgraded from version " + t.db.version +
                      " to version " + t.version + ".",
                  ),
                  t.version = t.db.version), s || i
              ) {
                if (i) {
                ...
                _initStorage: function (t) {
                  ...
                  return o.all(r).then(function () {
                    ...
                    for (var n = 0; n < c.length; n++) {
                      var r = c[n];
                      r !== e &&
                        (r._dbInfo.db = i.db, r._dbInfo.version = i.version);
                    }
                  });
                },
                _support: function () {
                    ...
                    i = new o(function (t, i) {
                      e.ready().then(function () {
                        _(e._dbInfo, "readonly", function (n, s) {
                          if (n) return i(n);
                          try {
                            var r = s.objectStore(e._dbInfo.storeName)
                                .openKeyCursor(),
                              o = [];
                            r.onsuccess = function () {
                              var e = r.result;
                        ...
                        return new o(function (e, i) {
                          ...
                          n.onerror = function () {
                            ...
                            n.onblocked = function () {
                              console.warn(
                                'dropInstance blocked for database "' + t.name +
            ...
            var j = {
              serialize: function (t, e) {
                ...
                if (
                  ...
                  r.onload = function () {
                    var i = "~~local_forage_type~" + t.type + "~" +
                      L(this.result);
                    e("__lfsc__:blob" + i);
            ...
            function D(t, e, i, n) {
              t.executeSql(
                "CREATE TABLE IF NOT EXISTS " + e.storeName +
                  ...
                  h.serializer.serialize(e, function (e, l) {
                    l ? o(l) : h.db.transaction(function (i) {
                      P(
                        i,
                        h,
                        "INSERT OR REPLACE INTO " + h.storeName +
                          " (key, value) VALUES (?, ?)",
                        [t, e],
                        function () {
                          r(a);
              ...
              removeItem: function (t, e) {
                ...
                var n = new o(function (e, n) {
                  i.ready().then(function () {
                    var s = i._dbInfo;
                    s.db.transaction(function (i) {
                      P(i, s, "DELETE FROM " + s.storeName + " WHERE key = ?", [
                        t,
                      ], function () {
                        e();
                      }, function (t, e) {
                    ...
                    ? new o(function (e) {
                      ...
                      return new o(function (e, i) {
                        t.db.transaction(function (n) {
                          ...
                          for (
                            var r = [], a = 0, h = t.storeNames.length;
                            a < h;
                            a++
            ...
            var U = {
                ...
                _initStorage: function (t) {
                  ...
                  return e.keyPrefix = q(t, this._defaultConfig),
                    F()
                      ? (this._dbInfo = e, e.serializer = j, o.resolve())
                      : o.reject();
                },
                _support: function () {
                  try {
                      ...
                      o.serializer.serialize(e, function (e, n) {
                        if (n) r(n);
                            ...
                            "QuotaExceededError" !== t.name &&
                              "NS_ERROR_DOM_QUOTA_REACHED" !== t.name || r(t),
                              r(t);
                          }}
                      });
                    });
              ...
              W = function (t, e) {
                for (var i, n, s = t.length, r = 0; r < s;) {
                  if (
                    (i = t[r]) === (n = e) ||
                    "number" == typeof i && "number" == typeof n && isNaN(i) &&
                      isNaN(n)
                  ) return !0;
                  r++;
                }
                ...
                t.prototype.defineDriver = function (t, e, i) {
                  var n = new o(function (e, i) {
                    try {
                      ...
                      for (
                        var r = K.concat("_initStorage"), h = 0, l = r.length;
                        h < l;
                        h++
                      ) {
                        var c = r[h];
                        if (
                          (!W($, c) || t[c]) && "function" != typeof t[c]
                        ) return void i(s);
                      }
                      !function () {
                        for (
              ...
              if (this.readyState === XMLHttpRequest.DONE) {
                ...
                if (
                  ...
                  i = t
                    ...
                    : "blob" == e
                    ? o ? this.response : new Blob([this.response])
                    : this.response, l.resolve(i);
                } else {l.reject({
                    status: this.status,
    ...
    var f = class {
      ...
      load(t) {
        var e = t || this.request || u, i = new r.defer(), n = i.promise;
        return this.contents
          ? i.resolve(this.contents)
          : e(this.url).then(function (t) {
            return this.document = t,
          ...
          !function (t) {
            for (
              ...
              ((h = e.document.createRange()).setStart(t, r),
                ...
                s = e.cfiFromRange(h),
                o = t.textContent.length < 150
                  ? t.textContent
                  : "..." + (o = t.textContent.substring(r - 75, r + 75)) +
                    "...",
                i.push({ cfi: s, excerpt: o })), l = r;
            }
          }(t);
        }),
          i;
      ...
      search(t, e = 5) {
        ...
        const n = this,
          s = t.toLowerCase(),
          r = function (t) {
            const e = t.reduce((t, e) => t + e.textContent, "").toLowerCase()
              .indexOf(s);
            if (-1 != e) {
              const r = 0, o = e + s.length;
              let a = 0, h = 0;
              if (e < t[r].length) {
                let s;
                ...
                let l = t[r], c = t[a], u = n.document.createRange();
                u.setStart(l, e);
                let d = t.slice(0, a).reduce(
                  (t, e) => t + e.textContent.length,
                  0,
                );
                u.setEnd(c, d > o ? o : o - d), s = n.cfiFromRange(u);
                let f = t.slice(0, a + 1).reduce(
                  (t, e) => t + e.textContent,
                  "",
                );
                f.length > 150 &&
    ...
    var p = class {
        ...
        get(t) {
          ...
          } else if (this.epubcfi.isCfiString(t)) e = new h.a(t).spinePos;
          else {"number" == typeof t || !1 === isNaN(t)
              ? e = t
    ...
    class v {
      ...
      process(t) {
        return t.load(this.request).then(function (e) {
          var i = new r.defer(), n = this.parse(e, t.cfiBase);
            ...
            function (t) {
              ...
              for (
                ...
                ((n = this.createRange()).startContainer = t,
                  n.startOffset = 0), (i = u - c) > r && (c += r, a = r);
                a < r;
              ) {
                if (
                  i = u - c,
      ...
      processWords(t, e, i, n) {
        return n && this._locationsWords.length >= n
          ? Promise.resolve()
          : t.load(this.request).then(function (s) {
            var o = new r.defer(),
      ...
      countWords(t) {
        return (t =
          (t = (t = t.replace(/(^\s*)|(\s*$)/gi, "")).replace(/[ ]{2,}/gi, " "))
            .replace(/\n /, "\n")).split(" ").length;
      }
      parseWords(t, e, i, n) {
        var s,
        ...
        return Object(r.sprint)(
          ...
          function (t) {
            ...
            if (
              t.textContent.length < 10 && 0 === t.textContent.trim().length
            ) return !1;
      ...
      locationFromCfi(t) {
        ...
        return h.a.prototype.isCfiString(t) && (t = new h.a(t)),
          0 === this._locations.length ? -1 : (e = Object(r.locationOf)(
            t,
            this._locations,
    ...
    var E = class {
      ...
      parseSpine(t, e) {
        var i = [], n = Object(r.qsa)(t, "itemref");
      ...
      findUniqueIdentifier(t) {
        ...
        return i && "identifier" === i.localName &&
      ...
      findCoverPath(t) {
        ...
        if (i) {
          var n = i.getAttribute("content"), s = t.getElementById(n);
    ...
    var S = class {
        ...
        parseNav(t) {
          var e = Object(r.querySelectorByType)(t, "nav", "toc"), i = [];
          if (!e) return i;
        ...
        landmarkItem(t) {
          ...
          if (!e) return;
          let i = e.getAttributeNS("http://www.idpf.org/2007/ops", "type") ||
            void 0;
          return {
    ...
    var C = class {
      ...
      split() {
        this.html = this.resources.filter(function (t) {
          if (
            "application/xhtml+xml" === t.type || "text/html" === t.type
          ) return !0;
        }),
      ...
      createUrl(t) {
        var e = new o.a(t), i = T.lookup(e.filename);
        return this.settings.archive
          ...
          ? this.settings.request(t, "blob").then((t) =>
            Object(r.blob2base64)(t)
          ).then((t) => Object(r.createBase64Url)(t, i))
          : this.settings.request(t, "blob").then((t) =>
            Object(r.createBlobUrl)(t, i)
          );
      }
      replacements() {
    ...
    var O = class {
        ...
        parse(t) {
          var e = Object(r.qs)(t, "html"), i = Object(r.qs)(t, "ncx");
        ...
        pageFromCfi(t) {
          ...
          return -1 != i ? e = this.pages[i] : void 0 !==
              (e = (i = Object(r.locationOf)(
                      t,
                      this.locations,
                      this.epubcfi.compare,
                    )) - 1 >= 0
    ...
    var A = class {
        ...
        getBlob(t, e) {
          var i = window.decodeURIComponent(t.substr(1)), n = this.zip.file(i);
          if (n) {
        ...
        createUrl(t, e) {
          ...
          return t in this.urlCache
            ...
            : (a
              ? (n = this.getBase64(t)) && n.then(function (e) {
                this.urlCache[t] = e, s.resolve(e);
              }.bind(this))
              : (n = this.getBlob(t)) && n.then(function (e) {
    ...
    class D {
      ...
      add(t, e) {
        let i = t.resources.map((t) => {
          ...
          return this.storage.getItem(s).then((t) =>
            !t || e
      ...
      put(t, e, i) {
        ...
        return this.storage.getItem(n).then((s) =>
          s ||
    ...
    class H {
      constructor(t, e) {
        void 0 === e && "string" != typeof t && t instanceof Blob == !1 &&
        t instanceof ArrayBuffer == !1 && (e = t, t = void 0),
          this.settings = Object(r.extend)(this.settings || {}, {
      ...
      load(t) {
        ...
        return this.archived ? this.archive.request(e) : this.request(
          e,
          null,
          this.settings.requestCredentials,
          this.settings.requestHeaders,
      ...
      determineType(t) {
        ...
        return "base64" === this.settings.encoding
          ...
          : ((e = new o.a(t).path().extension) && (e = e.replace(/\?.*$/, "")),
            e
              ? "epub" === e ? q : "opf" === e ? F : "json" === e ? U : void 0
              : W);
      }
      unpack(t) {
        this.package = t,
          "" === this.packaging.metadata.layout
            ? this.load(
              this.url.resolve("META-INF/com.apple.ibooks.display-options.xml"),
            ).then((t) => {
      ...
      loadNavigation(t) {
        let e = t.navPath || t.ncxPath, i = t.toc;
        return i
          ? new Promise((e, n) => {
      ...
      store(t) {
        let e = this.settings.replacements &&
      ...
      coverUrl() {
        return this.loaded.cover.then(() =>
          this.cover
            ? this.archived ? this.archive.createUrl(this.cover) : this.cover
            : null
        );
      }
      replacements() {
    ...
    function U(t, e) {
      var i = e.previousSibling, n = e.nextSibling;
    ...
    function st(t, e, i) {
      var s = t.prefix || "", r = t.namespaceURI;
      if (!r) return !1;
      ...
      switch (t.nodeType) {
        case c:
          var o = t.attributes,
            ...
            g = l;
          if (
            !(i = n.isHTML(t.namespaceURI) || i) && !t.prefix && t.namespaceURI
          ) {
            ...
            if (!x) {
              for (var S = r.length - 1; S >= 0; S--) {
                if (
                  "" === (N = r[S]).prefix && N.namespace === t.namespaceURI
                ) {
                  x = N.namespace;
                  break;
                }
    ...
    C.prototype = Error.prototype,
        ...
        cloneNode: function (t) {
          return function t(e, i, n) {
            ...
            switch (s.ownerDocument = e, s.nodeType) {
              case c:
                var a = i.attributes, h = s.attributes = new k(), l = a.length;
                h._ownerElement = s;
                for (var d = 0; d < l; d++) {
      ...
      B.prototype = {
        ...
        insertBefore: function (t, e) {
          ...
          return null == this.documentElement && t.nodeType == c &&
        ...
        createElementNS: function (t, e) {
          var i = new H(), n = e.split(":"), s = i.attributes = new k();
        ...
        getElementsByTagName: function (t) {
          return new I(this, function (e) {
            ...
            return z(e, function (n) {
              n === e || n.nodeType != c || "*" !== t && n.tagName != t ||
                i.push(n);
            }),
              i;
          });
      ...
      G.prototype = {
        ...
        splitText: function (t) {
          var e = this.data, i = e.substring(t);
          e = e.substring(0, t),
    ...
    i.r(e),
      function (t) {
        var n = i(24), s = i(16), r = i(2), o = i(12), a = i(0), h = i(1);
        i(20), i(10), i(22);
        function l(t, e) {
          return new n.a(t, e);
        }
    ...
    "use strict";
    var n = i(32), s = i(40), r = i(41), o = i(42);
    (t.exports = function (t, e) {
      ...
      return "string" != typeof t
        ...
        null == e
          ? e = void 0
          : r(e)
          ? null == i ? i = void 0 : r(i) || (l = i, i = void 0)
          : (l = e, e = i = void 0),
    ...
    var n = "razdwatrzy";
    t.exports = function () {
      return "function" == typeof n.contains &&
        (!0 === n.contains("dwa") && !1 === n.contains("foo"));
    };
  }, function (t, e, i) {
    "use strict";
    ...
    function p(t) {
      if (t) {
        return "\n@" + (t.systemId || "") + "#[line:" + t.lineNumber + ",col:" +
          t.columnNumber + "]";
      }
    }
    function g(t, e, i) {
    ...
    u.prototype.parseFromString = function (t, e) {
      ...
      d.prototype = {
        ...
        startElement: function (t, e, i, n) {
          var s = this.doc, r = s.createElementNS(t, i || e), o = n.length;
          m(this, r),
    ...
    function c(t, e, i, s, r, o) {
      function a(t, e, n) {
        ...
        o.fatalError("Attribute " + t + " redefined"), i.addValue(t, e, n);
      }
      for (var h, l = ++e, c = 0;;) {
        var u = t.charAt(l);
        switch (u) {
    ...
    function d(t, e, i, n, s) {
      if (/^(?:script|textarea)$/i.test(i)) {
        var r = t.indexOf("</" + i + ">", e), o = t.substring(e + 1, r);
        if (/[&<]/.test(o)) {
                ...
                try {
                  ...
                  if (_ < 0) {
                    if (!t.substr(N).match(/^\s*$/)) {
                      var T = s.doc, C = T.createTextNode(t.substr(N));
                  ...
                  switch (_ > N && h(_), t.charAt(_ + 1)) {
                    case "/":
                      ...
                      O < 0
                        ? (I = t.substring(_ + 2).replace(/[\s<].*/, ""),
                          r.error(
                            "end tag name: " + I + " is not complete:" +
                              R.tagName,
                          ),
                          O = _ + 1 + I.length)
                        : I.match(/\s</) &&
                          (I = I.replace(/[\s<].*/, ""),
                            ...
                            O = _ + 1 + I.length);
                      var k = R.localNSMap, A = R.tagName == I;
                      if (
                        A ||
                        R.tagName && R.tagName.toLowerCase() == I.toLowerCase()
                      ) {
                    ...
                    default:
                      ...
                      if (
                        !j.closed && f(t, O, j.tagName, S) &&
                        (j.closed = !0,
                          i.nbsp || r.warning("unclosed xml attribute")), x && P
                      ) {
    ...
    function n(t, e) {
      function i(i) {
        for (var n = e.length - 1; n >= 0; n--) {
          var o = e[n], a = i.clientX, h = i.clientY;
          if (
            i.touches && i.touches.length &&
            (a = i.touches[0].clientX, h = i.touches[0].clientY), r(o, t, a, h)
          ) {
            o.dispatchEvent(s(i));
            break;
          }
    ...
    var n = i(27), s = i(58), r = i(59), o = n ? n.toStringTag : void 0;
    t.exports = function (t) {
      return null == t
